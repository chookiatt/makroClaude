...
test('test', async ({ page }) => {
  ...
  await page.goto('https://sgm-store-empower.mango-qa.siammakro.cloud/index.html');
  ...
  await page.getByLabel('Edit Price Request Detail').locator('div').filter({ hasText: /^Competitor Price$/ }).click();
