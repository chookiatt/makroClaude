...
test('TSN_01', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Upload image Browse...' }).click();
  await page.getByRole('button', { name: 'Upload image Browse...' }).setInputFiles('244402_sign.jpg');
